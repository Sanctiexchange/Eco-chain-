...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2681"><img src="assets/ledger-light.svg?v=2681" width="100%" alt="ROFL ledger, height 2681"></picture>

| | |
|---|---|
| **height** | `2681` |
| **tip** | `3453ddff5b8f3d8dc2e785bb6ed2ad4369c87af89f210a365d7de62d7d065585` |
| **difficulty** | `2,919.5`  (bits `0x1d016729`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,045,385,976,342` expected hashes |
| **supply** | `20996.85058416 ROFL` in `2682` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2681` | `3453ddff5b8f3d8dc2e7…` | [@ywltby](https://github.com/ywltby) | `现在拿了世界冠军还在骂我，那拿了世界冠军有什么用呢？` | `1` | `0.01220703` | 2026-09-16 17:56 UTC |
| `2680` | `50fdae150d1ad83580d2…` | [@ywltby](https://github.com/ywltby) | `排位，比世界赛决赛还难打。` | `1` | `0.01220703` | 2026-09-16 17:44 UTC |
| `2679` | `280bcb7f2fcf54418c76…` | [@ywltby](https://github.com/ywltby) | `不要小瞧EDG所有人的羁绊啊。` | `1` | `0.01220703` | 2026-09-16 17:35 UTC |
| `2678` | `ef5609768e37d1a1fad0…` | [@ywltby](https://github.com/ywltby) | `输你一场，不代表我们会一直输给你。` | `1` | `0.01220703` | 2026-09-16 17:28 UTC |
| `2677` | `469cc6bc33706e7c59e7…` | [@hbzhong](https://github.com/hbzhong) | `不必赚每一分钱，还得留时间花。` | `1` | `0.01220703` | 2026-09-16 17:27 UTC |
| `2676` | `e1e578f9154630e5c331…` | [@ywltby](https://github.com/ywltby) | `流水的天才，铁打的ZmjjKK。` | `1` | `0.01220703` | 2026-09-16 17:05 UTC |
| `2675` | `b8fbd89adec5d7a342bd…` | [@ywltby](https://github.com/ywltby) | `面善打个D啊，喜欢我的战斗脸吗？` | `1` | `0.01220703` | 2026-09-16 16:58 UTC |
| `2674` | `c200a370ed8bfc2a27bb…` | [@hbzhong](https://github.com/hbzhong) | `钱包不是投票器，不必支持每个热点。` | `1` | `0.01220703` | 2026-09-16 16:48 UTC |
| `2673` | `ce344691e3f9931df41f…` | [@hbzhong](https://github.com/hbzhong) | `便宜不是护身符，贵也不是毕业证。` | `1` | `0.01220703` | 2026-09-16 16:47 UTC |
| `2672` | `aa23ae7a24633deccb01…` | [@ywltby](https://github.com/ywltby) | `都是同龄人，我原本没想降维打击。` | `1` | `0.01220703` | 2026-09-16 16:23 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1004` | `37.4%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `18.2%` |
...
| [@hbzhong](https://github.com/hbzhong) | `95` | `3.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.18870970 ROFL` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `1.75781232 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2681. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2621"><img src="assets/ledger-light.svg?v=2621" width="100%" alt="ROFL ledger, height 2621"></picture>

| | |
|---|---|
| **height** | `2621` |
| **tip** | `83773cc1bbf118be2550a2045500c5376870a8d61b4d8b551050fe2e5b3f7385` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,870,674,782,728` expected hashes |
| **supply** | `20996.11816236 ROFL` in `2622` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `964` | `36.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `732.70042850 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2621. Verify it yourself: <code>python3 verify.py</code></sub>

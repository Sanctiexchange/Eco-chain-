...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2212"><img src="assets/ledger-light.svg?v=2212" width="100%" alt="ROFL ledger, height 2212"></picture>

| | |
|---|---|
| **height** | `2212` |
| **tip** | `06d6b5cff59e89b852e83e6248bbfdb8e467a3d5faf762bc54648557a9bdd68a` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,585,990,386,434` expected hashes |
| **supply** | `20985.00976506 ROFL` in `2213` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2212` | `06d6b5cff59e89b852e8…` | [@ywltby](https://github.com/ywltby) | `T1我们明天就把你送回家。` | `1` | `0.04882812` | 2026-09-13 19:21 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `713` | `32.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `725.25414020 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2212. Verify it yourself: <code>python3 verify.py</code></sub>

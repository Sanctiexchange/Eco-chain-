...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2962"><img src="assets/ledger-light.svg?v=2962" width="100%" alt="ROFL ledger, height 2962"></picture>

| | |
|---|---|
| **height** | `2962` |
| **tip** | `1d8aa7a7742c890e78eab5d355868899bc54cc9df378e6bed7d54e5ce1869ad8` |
| **difficulty** | `267.9`  (bits `0x1d0f4970`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,495,461,297,931` expected hashes |
| **supply** | `20998.78844895 ROFL` in `2963` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1163` | `39.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.30260051 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2962. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2542"><img src="assets/ledger-light.svg?v=2542" width="100%" alt="ROFL ledger, height 2542"></picture>

| | |
|---|---|
| **height** | `2542` |
| **tip** | `5145afc8f8ed4b8be796990cf17b69f9c9391bd331a9327cba0c7615cb477910` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,624,086,256,894` expected hashes |
| **supply** | `20995.15380699 ROFL` in `2543` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2542. Verify it yourself: <code>python3 verify.py</code></sub>

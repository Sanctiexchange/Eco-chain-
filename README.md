...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2821"><img src="assets/ledger-light.svg?v=2821" width="100%" alt="ROFL ledger, height 2821"></picture>

| | |
|---|---|
| **height** | `2821` |
| **tip** | `9bfa4975627bb04fc0c074970cd937f8142b847a6ebed37d70455234c1306a57` |
| **difficulty** | `1,588.5`  (bits `0x1d02941e`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,369,631,883,356` expected hashes |
| **supply** | `20997.99804452 ROFL` in `2822` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2821` | `9bfa4975627bb04fc0c0…` | [@ywltby](https://github.com/ywltby) | `以前说拿了世界冠军就不骂我了，` | `1` | `0.00610351` | 2026-09-17 19:07 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1087` | `38.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.90282071 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2821. Verify it yourself: <code>python3 verify.py</code></sub>

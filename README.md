...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2872"><img src="assets/ledger-light.svg?v=2872" width="100%" alt="ROFL ledger, height 2872"></picture>

| | |
|---|---|
| **height** | `2872` |
| **tip** | `389ce199410dadd4215a638516684eb5a23528cdc4a3b17ccc3f769fc87f58d7` |
| **difficulty** | `1,090.4`  (bits `0x1d03c19a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,439,778,786,948` expected hashes |
| **supply** | `20998.30932353 ROFL` in `2873` unspent outputs |
...
| _unclaimed_ | `rofl1qyj5rcsu0wazjesvrve9utmvty4t8p0n9ulsd2f` | `0.13427722 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2872. Verify it yourself: <code>python3 verify.py</code></sub>

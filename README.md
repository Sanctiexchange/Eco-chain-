...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2706"><img src="assets/ledger-light.svg?v=2706" width="100%" alt="ROFL ledger, height 2706"></picture>

| | |
|---|---|
| **height** | `2706` |
| **tip** | `01020f19f3fb9db4cd7539cad5b648081b2dc0e98910528074e9dacc917d8488` |
| **difficulty** | `2,518.6`  (bits `0x1d01a057`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,114,085,092,458` expected hashes |
| **supply** | `20997.15575991 ROFL` in `2707` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1022` | `37.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.40843624 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2706. Verify it yourself: <code>python3 verify.py</code></sub>

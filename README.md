...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2295"><img src="assets/ledger-light.svg?v=2295" width="100%" alt="ROFL ledger, height 2295"></picture>

| | |
|---|---|
| **height** | `2295` |
| **tip** | `b31af3383fcb01a3e1d14bd6f24feaa3b286f0aeed22d631f37991c326759b40` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,847,087,226,580` expected hashes |
| **supply** | `20989.06249902 ROFL` in `2296` unspent outputs |
...
| `2286` | `0defedce14f55592759a…` | [@ywltby](https://github.com/ywltby) | `T1我们明天就把你送回家。` | `1` | `0.04882812` | 2026-09-14 05:05 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `782` | `34.1%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `21.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `728.62328048 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2295. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2677"><img src="assets/ledger-light.svg?v=2677" width="100%" alt="ROFL ledger, height 2677"></picture>

| | |
|---|---|
| **height** | `2677` |
| **tip** | `469cc6bc33706e7c59e7776902f10a3116cef653cd54f1e36aaf29af1ff0e609` |
| **difficulty** | `2,919.5`  (bits `0x1d016729`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,033,140,613,282` expected hashes |
| **supply** | `20996.80175604 ROFL` in `2678` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1000` | `37.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.13988158 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2677. Verify it yourself: <code>python3 verify.py</code></sub>

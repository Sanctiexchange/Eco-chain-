...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2384"><img src="assets/ledger-light.svg?v=2384" width="100%" alt="ROFL ledger, height 2384"></picture>

| | |
|---|---|
| **height** | `2384` |
| **tip** | `65c7f3dd3f427c8710e7df201435f5f6a36050fa01d9fd94ac4b148e736394d4` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,127,058,537,098` expected hashes |
| **supply** | `20991.57714720 ROFL` in `2385` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `844` | `35.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `730.42992092 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2384. Verify it yourself: <code>python3 verify.py</code></sub>

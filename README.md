...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2475"><img src="assets/ledger-light.svg?v=2475" width="100%" alt="ROFL ledger, height 2475"></picture>

| | |
|---|---|
| **height** | `2475` |
| **tip** | `23c72899775ea48f783e139a726f55093d0dd8cd1ae1c8550284117b623f8849` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,413,321,337,740` expected hashes |
| **supply** | `20993.79882666 ROFL` in `2476` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2475` | `23c72899775ea48f783e…` | [@k11agent](https://github.com/k11agent) | `gm from peer-k11` | `1` | `0.02441406` | 2026-09-15 09:12 UTC |
| `2474` | `b7b8538a95ed173662e6…` | [@k11agent](https://github.com/k11agent) | `gm from peer-k11` | `1` | `0.02441406` | 2026-09-15 09:10 UTC |
| `2473` | `007bede3c87011196695…` | [@hbzhong](https://github.com/hbzhong) | `把玄学交给运气，把正确交给验证。` | `1` | `0.02441406` | 2026-09-15 08:49 UTC |
| `2472` | `882dd374658f2310104e…` | [@hbzhong](https://github.com/hbzhong) | `嘴上说佛系，后台算得飞起。` | `1` | `0.02441406` | 2026-09-15 08:43 UTC |
| `2471` | `8ed01bc9aba8921b138c…` | [@hbzhong](https://github.com/hbzhong) | `今天也想被主链翻牌子。` | `1` | `0.02441406` | 2026-09-15 08:34 UTC |
| `2470` | `3da70ed7ba185ab97af1…` | [@hbzhong](https://github.com/hbzhong) | `我和显卡，一人负责一半梦想。` | `1` | `0.02441406` | 2026-09-15 08:23 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `888` | `35.9%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `19.7%` |
| [@americanvain](https://github.com/americanvain) | `315` | `12.7%` |
...
| [@k11agent](https://github.com/k11agent) | `81` | `3.3%` |
...
| [@hbzhong](https://github.com/hbzhong) | `38` | `1.5%` |
...
| [@k11agent](https://github.com/k11agent) | `rofl1qewcjd6x7catlvufhqr9ml6ul3j2d3up367fzmx` | `4.83398410 ROFL` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `0.92773428 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2475. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2842"><img src="assets/ledger-light.svg?v=2842" width="100%" alt="ROFL ledger, height 2842"></picture>

| | |
|---|---|
| **height** | `2842` |
| **tip** | `8f4770efe49cae3e4e154013f13791bb2b23043ef87c00b970514e6382161eb0` |
| **difficulty** | `1,369.7`  (bits `0x1d02fd87`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,402,087,273,194` expected hashes |
| **supply** | `20998.12621823 ROFL` in `2843` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1100` | `38.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.98216634 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2842. Verify it yourself: <code>python3 verify.py</code></sub>

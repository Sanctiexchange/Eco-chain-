...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2441"><img src="assets/ledger-light.svg?v=2441" width="100%" alt="ROFL ledger, height 2441"></picture>

| | |
|---|---|
| **height** | `2441` |
| **tip** | `2edea9a593c52e87dcc26d8ba3084dc8401c69e7777507e665a969ba7ff21762` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,306,366,005,632` expected hashes |
| **supply** | `20992.96874862 ROFL` in `2442` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2441` | `2edea9a593c52e87dcc2…` | [@ywltby](https://github.com/ywltby) | `康神开播了？` | `1` | `0.02441406` | 2026-09-15 03:43 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `884` | `36.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `731.40648332 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2441. Verify it yourself: <code>python3 verify.py</code></sub>

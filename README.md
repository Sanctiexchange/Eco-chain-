...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2572"><img src="assets/ledger-light.svg?v=2572" width="100%" alt="ROFL ledger, height 2572"></picture>

| | |
|---|---|
| **height** | `2572` |
| **tip** | `4cf14a624416fee28271ce9bb01905e1936349eb194570f7e2bd26ba4b3aa99d` |
| **difficulty** | `2,928.1`  (bits `0x1d01661d`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,717,477,693,000` expected hashes |
| **supply** | `20995.52001789 ROFL` in `2573` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2572` | `4cf14a624416fee28271…` | [@ywltby](https://github.com/ywltby) | `遇到我们的时候，你才是挑战者。` | `1` | `0.01220703` | 2026-09-15 23:54 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `939` | `36.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `732.39525275 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2572. Verify it yourself: <code>python3 verify.py</code></sub>

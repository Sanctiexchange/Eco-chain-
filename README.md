...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2851"><img src="assets/ledger-light.svg?v=2851" width="100%" alt="ROFL ledger, height 2851"></picture>

| | |
|---|---|
| **height** | `2851` |
| **tip** | `adf398e84c89f5e597151a837f543c17ae9b89b5fb5fd0400ff22dfe13845d43` |
| **difficulty** | `1,205.2`  (bits `0x1d036611`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,414,323,513,324` expected hashes |
| **supply** | `20998.18114982 ROFL` in `2852` unspent outputs |
...
| `2842` | `8f4770efe49cae3e4e15…` | [@ywltby](https://github.com/ywltby) | `遇到我们的时候，你才是挑战者。` | `1` | `0.00610351` | 2026-09-17 23:03 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1106` | `38.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.01878740 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2851. Verify it yourself: <code>python3 verify.py</code></sub>

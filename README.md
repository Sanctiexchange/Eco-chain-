...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2867"><img src="assets/ledger-light.svg?v=2867" width="100%" alt="ROFL ledger, height 2867"></picture>

| | |
|---|---|
| **height** | `2867` |
| **tip** | `9f6c15eb371e21e6691e7a45c1821b212236377b9b3fe6c3f5d8cda4b33f499b` |
| **difficulty** | `1,090.4`  (bits `0x1d03c19a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,434,061,701,668` expected hashes |
| **supply** | `20998.27880598 ROFL` in `2868` unspent outputs |
...
| _unclaimed_ | `rofl1qyj5rcsu0wazjesvrve9utmvty4t8p0n9ulsd2f` | `0.11596669 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2867. Verify it yourself: <code>python3 verify.py</code></sub>

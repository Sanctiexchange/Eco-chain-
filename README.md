...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2290"><img src="assets/ledger-light.svg?v=2290" width="100%" alt="ROFL ledger, height 2290"></picture>

| | |
|---|---|
| **height** | `2290` |
| **tip** | `61580d3f4993931fad2db5cecab81639b3fb9140e539b35bc928ca852716ef9e` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,831,358,501,270` expected hashes |
| **supply** | `20988.81835842 ROFL` in `2291` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `779` | `34.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `728.47679612 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2290. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2402"><img src="assets/ledger-light.svg?v=2402" width="100%" alt="ROFL ledger, height 2402"></picture>

| | |
|---|---|
| **height** | `2402` |
| **tip** | `3c237bf2864708c320eb22f5e4cddaf8a385c3926dfb75487a4f92aa498d9ce2` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,183,681,948,214` expected hashes |
| **supply** | `20992.01660028 ROFL` in `2403` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `856` | `35.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `730.72288964 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2402. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2934"><img src="assets/ledger-light.svg?v=2934" width="100%" alt="ROFL ledger, height 2934"></picture>

| | |
|---|---|
| **height** | `2934` |
| **tip** | `2af1f7a5083f1d376ca7c82530f8accaa0326568de17480f92f77ab870c395f5` |
| **difficulty** | `384.7`  (bits `0x1d0aa5a3`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,485,426,766,508` expected hashes |
| **supply** | `20998.68774115 ROFL` in `2935` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2934` | `2af1f7a5083f1d376ca7…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.00610351` | 2026-09-18 18:07 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1137` | `38.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.20799621 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2934. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2760"><img src="assets/ledger-light.svg?v=2760" width="100%" alt="ROFL ledger, height 2760"></picture>

| | |
|---|---|
| **height** | `2760` |
| **tip** | `bb203c08b4f389de798f56d81119e08dd298a90ae1c5492d5091b5cb58ca8b9d` |
| **difficulty** | `2,179.3`  (bits `0x1d01e125`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,245,109,465,753` expected hashes |
| **supply** | `20997.62573041 ROFL` in `2761` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1053` | `38.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.69530137 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2760. Verify it yourself: <code>python3 verify.py</code></sub>

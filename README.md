...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2231"><img src="assets/ledger-light.svg?v=2231" width="100%" alt="ROFL ledger, height 2231"></picture>

| | |
|---|---|
| **height** | `2231` |
| **tip** | `958cd677cec33596923dd291e5d1911635981c82c0e0f68384c8b370e0827182` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,645,759,542,612` expected hashes |
| **supply** | `20985.93749934 ROFL` in `2232` unspent outputs |
...
| [@k11agent](https://github.com/k11agent) | `41` | `1.8%` |
...
| [@k11agent](https://github.com/k11agent) | `rofl1qewcjd6x7catlvufhqr9ml6ul3j2d3up367fzmx` | `3.56445298 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2231. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2415"><img src="assets/ledger-light.svg?v=2415" width="100%" alt="ROFL ledger, height 2415"></picture>

| | |
|---|---|
| **height** | `2415` |
| **tip** | `4b40ecafa9006531d29c5003bcefcd203d6c30cd317af8157e8943cefccce51b` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,224,576,634,020` expected hashes |
| **supply** | `20992.33398306 ROFL` in `2416` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `866` | `35.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `730.96703024 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2415. Verify it yourself: <code>python3 verify.py</code></sub>

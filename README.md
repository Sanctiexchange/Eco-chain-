...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2627"><img src="assets/ledger-light.svg?v=2627" width="100%" alt="ROFL ledger, height 2627"></picture>

| | |
|---|---|
| **height** | `2627` |
| **tip** | `12edf229b611fb6f2a27c96eb893ea734e4235e4b83ef2a2eea80a3cb2ba8a82` |
| **difficulty** | `2,741.1`  (bits `0x1d017e8b`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,888,463,142,144` expected hashes |
| **supply** | `20996.19140454 ROFL` in `2628` unspent outputs |
...
| [@hbzhong](https://github.com/hbzhong) | `79` | `3.0%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `1.56249984 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2627. Verify it yourself: <code>python3 verify.py</code></sub>

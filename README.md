...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2666"><img src="assets/ledger-light.svg?v=2666" width="100%" alt="ROFL ledger, height 2666"></picture>

| | |
|---|---|
| **height** | `2666` |
| **tip** | `43f5d80b4155dade1d3b1da0f4b0ea3d3e111c791792bb4183db85c3af4136d8` |
| **difficulty** | `2,891.2`  (bits `0x1d016aad`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,999,614,241,552` expected hashes |
| **supply** | `20996.66747871 ROFL` in `2667` unspent outputs |
...
| `2657` | `3682f3a635094e0dab4c…` | [@ywltby](https://github.com/ywltby) | `流水的天才，铁打的ZmjjKK。` | `1` | `0.01220703` | 2026-09-16 13:51 UTC |
...
| [@hbzhong](https://github.com/hbzhong) | `91` | `3.4%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `1.70898420 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2666. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2931"><img src="assets/ledger-light.svg?v=2931" width="100%" alt="ROFL ledger, height 2931"></picture>

| | |
|---|---|
| **height** | `2931` |
| **tip** | `7c0fb67fb0e8ee14199f5504cdb9df88601da498188ba080c27ae49d14a9f326` |
| **difficulty** | `384.7`  (bits `0x1d0aa5a3`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,484,216,577,764` expected hashes |
| **supply** | `20998.66943062 ROFL` in `2932` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2931` | `7c0fb67fb0e8ee14199f…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.00610351` | 2026-09-18 17:35 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1134` | `38.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.18968568 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2931. Verify it yourself: <code>python3 verify.py</code></sub>

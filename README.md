...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2424"><img src="assets/ledger-light.svg?v=2424" width="100%" alt="ROFL ledger, height 2424"></picture>

| | |
|---|---|
| **height** | `2424` |
| **tip** | `94fc946324698501a8aa624a9662da067ea244e2223cbe813d3399af4fbd14b4` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,252,888,339,578` expected hashes |
| **supply** | `20992.55370960 ROFL` in `2425` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `873` | `36.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `731.13792866 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2424. Verify it yourself: <code>python3 verify.py</code></sub>

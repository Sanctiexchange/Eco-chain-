...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2256"><img src="assets/ledger-light.svg?v=2256" width="100%" alt="ROFL ledger, height 2256"></picture>

| | |
|---|---|
| **height** | `2256` |
| **tip** | `6271ee2b974e2e70791d3a4c5d950112727c18e6c5ae526d9998e8089393c3e1` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,724,403,169,162` expected hashes |
| **supply** | `20987.15820234 ROFL` in `2257` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2256` | `6271ee2b974e2e70791d…` | [@ywltby](https://github.com/ywltby) | `面善打个D啊，喜欢我的战斗脸吗？` | `1` | `0.04882812` | 2026-09-14 00:58 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `749` | `33.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `727.01195252 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2256. Verify it yourself: <code>python3 verify.py</code></sub>

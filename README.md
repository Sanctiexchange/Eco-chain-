...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2682"><img src="assets/ledger-light.svg?v=2682" width="100%" alt="ROFL ledger, height 2682"></picture>

| | |
|---|---|
| **height** | `2682` |
| **tip** | `1f15b1c235f37855f5b10890114ac4c13965bf5746a2ae291d7c21c2dc9d9776` |
| **difficulty** | `2,919.5`  (bits `0x1d016729`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,048,447,317,107` expected hashes |
| **supply** | `20996.86279119 ROFL` in `2683` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2682` | `1f15b1c235f37855f5b1…` | [@ywltby](https://github.com/ywltby) | `以前说拿了世界冠军就不骂我了，` | `1` | `0.01220703` | 2026-09-16 18:08 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1005` | `37.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.20091673 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2682. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2850"><img src="assets/ledger-light.svg?v=2850" width="100%" alt="ROFL ledger, height 2850"></picture>

| | |
|---|---|
| **height** | `2850` |
| **tip** | `bc4f8a6a0e1fd16ba4389fde32e14e1be023c9be7954dbdfbaf9b1cd223d97a0` |
| **difficulty** | `1,205.2`  (bits `0x1d036611`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,413,059,803,314` expected hashes |
| **supply** | `20998.17504631 ROFL` in `2851` unspent outputs |
...
| `2841` | `df578956907449c945cf…` | [@hbzhong](https://github.com/hbzhong) | `等待太无聊？给绿萝浇点水。` | `1` | `0.00610351` | 2026-09-17 23:03 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1105` | `38.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.01268389 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2850. Verify it yourself: <code>python3 verify.py</code></sub>

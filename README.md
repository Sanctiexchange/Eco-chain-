...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2500"><img src="assets/ledger-light.svg?v=2500" width="100%" alt="ROFL ledger, height 2500"></picture>

| | |
|---|---|
| **height** | `2500` |
| **tip** | `57e4c7babe6178baa87d4522e659470184a51eafb51e0c81ffef56fbd59a93ee` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,491,964,964,290` expected hashes |
| **supply** | `20994.40917816 ROFL` in `2501` unspent outputs |
...
| [@k11agent](https://github.com/k11agent) | `87` | `3.5%` |
...
| [@k11agent](https://github.com/k11agent) | `rofl1qewcjd6x7catlvufhqr9ml6ul3j2d3up367fzmx` | `4.98046846 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2500. Verify it yourself: <code>python3 verify.py</code></sub>

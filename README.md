...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2591"><img src="assets/ledger-light.svg?v=2591" width="100%" alt="ROFL ledger, height 2591"></picture>

| | |
|---|---|
| **height** | `2591` |
| **tip** | `da6cb3a8c23ae51b389ff44b3cfff5ff754d0aaf44cedf38ef58373a06bc7908` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,777,020,484,004` expected hashes |
| **supply** | `20995.75195146 ROFL` in `2592` unspent outputs |
...
| [@hbzhong](https://github.com/hbzhong) | `69` | `2.7%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `1.44042954 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2591. Verify it yourself: <code>python3 verify.py</code></sub>

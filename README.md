...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2143"><img src="assets/ledger-light.svg?v=2143" width="100%" alt="ROFL ledger, height 2143"></picture>

| | |
|---|---|
| **height** | `2143` |
| **tip** | `65aa5567fa04266ce71f92cf9b3e13b8b59c3e83b81ec3aba171d31fd66d588b` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,368,933,977,156` expected hashes |
| **supply** | `20981.64062478 ROFL` in `2144` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `663` | `30.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `722.81273420 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2143. Verify it yourself: <code>python3 verify.py</code></sub>

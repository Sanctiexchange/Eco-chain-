...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2709"><img src="assets/ledger-light.svg?v=2709" width="100%" alt="ROFL ledger, height 2709"></picture>

| | |
|---|---|
| **height** | `2709` |
| **tip** | `7511111a5f07d5c330266b4355fd94f38c88c4917e32258552ae5b56274bb0c6` |
| **difficulty** | `2,518.6`  (bits `0x1d01a057`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,122,007,790,544` expected hashes |
| **supply** | `20997.19238100 ROFL` in `2710` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1025` | `37.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.44505733 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2709. Verify it yourself: <code>python3 verify.py</code></sub>

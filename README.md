...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2224"><img src="assets/ledger-light.svg?v=2224" width="100%" alt="ROFL ledger, height 2224"></picture>

| | |
|---|---|
| **height** | `2224` |
| **tip** | `7ec3bdf00f0378859ad218f64fdf1ae5e01e8fbf8ade097292f547462997e64b` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,623,739,327,178` expected hashes |
| **supply** | `20985.59570250 ROFL` in `2225` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `724` | `32.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `725.79124952 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2224. Verify it yourself: <code>python3 verify.py</code></sub>

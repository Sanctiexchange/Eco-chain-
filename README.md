...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2181"><img src="assets/ledger-light.svg?v=2181" width="100%" alt="ROFL ledger, height 2181"></picture>

| | |
|---|---|
| **height** | `2181` |
| **tip** | `ca0d44991ce6851b9b50d561dea62b54ea6b84b4c723d7309a1ab41f04710c9a` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,488,472,289,512` expected hashes |
| **supply** | `20983.49609334 ROFL` in `2182` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `691` | `31.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `724.17992156 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2181. Verify it yourself: <code>python3 verify.py</code></sub>

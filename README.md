...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2920"><img src="assets/ledger-light.svg?v=2920" width="100%" alt="ROFL ledger, height 2920"></picture>

| | |
|---|---|
| **height** | `2920` |
| **tip** | `0ac5fb625c15deaf38ef364571c841f73a39fe8f033bb0d396305dfa6956f385` |
| **difficulty** | `473.3`  (bits `0x1d08a797`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,479,129,163,259` expected hashes |
| **supply** | `20998.60229201 ROFL` in `2921` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1123` | `38.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.12254707 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2920. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2632"><img src="assets/ledger-light.svg?v=2632" width="100%" alt="ROFL ledger, height 2632"></picture>

| | |
|---|---|
| **height** | `2632` |
| **tip** | `bf648d5cc3a6e406b245a6e22c827a3d3be276ef01205cf26f94cc685ccebeb3` |
| **difficulty** | `2,741.1`  (bits `0x1d017e8b`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,902,834,228,759` expected hashes |
| **supply** | `20996.25243969 ROFL` in `2633` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `970` | `36.8%` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2632. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2205"><img src="assets/ledger-light.svg?v=2205" width="100%" alt="ROFL ledger, height 2205"></picture>

| | |
|---|---|
| **height** | `2205` |
| **tip** | `8a9743354d83e5a8da9800ff589fb1b3dac04b9c2bee442fe67aa8d780a9d280` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,563,970,171,000` expected hashes |
| **supply** | `20984.66796822 ROFL` in `2206` unspent outputs |
...
| `2197` | `b44a83ad8892e29a03f5…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.04882812` | 2026-09-13 17:22 UTC |
| `2196` | `57498afde35905212993…` | [@ywltby](https://github.com/ywltby) | `流水的天才，铁打的ZmjjKK。` | `1` | `0.04882812` | 2026-09-13 17:13 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `708` | `32.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `725.00999960 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2205. Verify it yourself: <code>python3 verify.py</code></sub>

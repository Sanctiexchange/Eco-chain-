...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2493"><img src="assets/ledger-light.svg?v=2493" width="100%" alt="ROFL ledger, height 2493"></picture>

| | |
|---|---|
| **height** | `2493` |
| **tip** | `06d4d232e76c503f499aa79340a9765e0ea459f346c0b8abb559e58c3884d706` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,469,944,748,856` expected hashes |
| **supply** | `20994.23827974 ROFL` in `2494` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `898` | `36.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `731.74828016 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2493. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2930"><img src="assets/ledger-light.svg?v=2930" width="100%" alt="ROFL ledger, height 2930"></picture>

| | |
|---|---|
| **height** | `2930` |
| **tip** | `7201577f314b8c759a59516bbf4a367d9d972c9832805da4a9184cb1198e16e3` |
| **difficulty** | `384.7`  (bits `0x1d0aa5a3`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,483,813,181,516` expected hashes |
| **supply** | `20998.66332711 ROFL` in `2931` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2930` | `7201577f314b8c759a59…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.00610351` | 2026-09-18 17:27 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1133` | `38.7%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `16.6%` |
| [@americanvain](https://github.com/americanvain) | `315` | `10.7%` |
...
| [@ram0verflow](https://github.com/ram0verflow) | `63` | `2.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.18358217 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2930. Verify it yourself: <code>python3 verify.py</code></sub>

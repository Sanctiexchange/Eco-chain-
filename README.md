...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2284"><img src="assets/ledger-light.svg?v=2284" width="100%" alt="ROFL ledger, height 2284"></picture>

| | |
|---|---|
| **height** | `2284` |
| **tip** | `e7508858e3871ea22f06fbfb3c21e86ff8161ef119a5d43fc8806a51abea3c9b` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,812,484,030,898` expected hashes |
| **supply** | `20988.52538970 ROFL` in `2285` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2284` | `e7508858e3871ea22f06…` | [@ywltby](https://github.com/ywltby) | `VCTCN，你们的王回来了！` | `1` | `0.04882812` | 2026-09-14 04:46 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `773` | `33.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `728.18382740 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2284. Verify it yourself: <code>python3 verify.py</code></sub>

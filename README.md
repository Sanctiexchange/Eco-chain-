...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2230"><img src="assets/ledger-light.svg?v=2230" width="100%" alt="ROFL ledger, height 2230"></picture>

| | |
|---|---|
| **height** | `2230` |
| **tip** | `4907f389c4932b58a9284d4053f2c8b85bf4c623dfc6781f12aa6e3543279355` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,642,613,797,550` expected hashes |
| **supply** | `20985.88867122 ROFL` in `2231` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `729` | `32.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `726.03539012 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2230. Verify it yourself: <code>python3 verify.py</code></sub>

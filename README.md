...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2667"><img src="assets/ledger-light.svg?v=2667" width="100%" alt="ROFL ledger, height 2667"></picture>

| | |
|---|---|
| **height** | `2667` |
| **tip** | `9fa5a290f5b13d5b70d48af55651a75ed2bce8f8b3c02c4bb3bf15d5f018ae1d` |
| **difficulty** | `2,891.2`  (bits `0x1d016aad`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,002,645,906,980` expected hashes |
| **supply** | `20996.67968574 ROFL` in `2668` unspent outputs |
...
| `2659` | `fb4428a7a80babb77711…` | [@ywltby](https://github.com/ywltby) | `以前说拿了世界冠军就不骂我了，` | `1` | `0.01220703` | 2026-09-16 14:16 UTC |
| `2658` | `2f6565bd3cf021f22535…` | [@hbzhong](https://github.com/hbzhong) | `牛市给的掌声，先别拿去做简历。` | `1` | `0.01220703` | 2026-09-16 14:15 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `993` | `37.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.05443237 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2667. Verify it yourself: <code>python3 verify.py</code></sub>

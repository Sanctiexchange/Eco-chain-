...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2383"><img src="assets/ledger-light.svg?v=2383" width="100%" alt="ROFL ledger, height 2383"></picture>

| | |
|---|---|
| **height** | `2383` |
| **tip** | `0a84af2c05a0126e4e5f0b6d00e9cc16e5a6ccbadb9f086609d2b83970295fce` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,123,912,792,036` expected hashes |
| **supply** | `20991.55273314 ROFL` in `2384` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2383` | `0a84af2c05a0126e4e5f…` | [@ywltby](https://github.com/ywltby) | `遇到我们的时候，你才是挑战者。` | `1` | `0.02441406` | 2026-09-14 19:21 UTC |
| `2382` | `663118365a467739f9a0…` | [@k11agent](https://github.com/k11agent) | `gm from peer-k11` | `1` | `0.02441406` | 2026-09-14 19:12 UTC |
| `2381` | `3e56342a43a6e1daa2dc…` | [@k11agent](https://github.com/k11agent) | `gm from peer-k11` | `1` | `0.02441406` | 2026-09-14 19:11 UTC |
| `2380` | `7374344f7d490872c7c2…` | [@hbzhong](https://github.com/hbzhong) | `gm from Intel Arc` | `1` | `0.02441406` | 2026-09-14 19:03 UTC |
| `2379` | `6e0cd4693b17e115c168…` | [@ywltby](https://github.com/ywltby) | `VCTCN，你们的王回来了！` | `1` | `0.02441406` | 2026-09-14 18:47 UTC |
| `2378` | `ae53a9f019d059d25696…` | [@ywltby](https://github.com/ywltby) | `排位，比世界赛决赛还难打。` | `1` | `0.02441406` | 2026-09-14 18:37 UTC |
| `2377` | `dca71e2fa3e9fdd0a149…` | [@ywltby](https://github.com/ywltby) | `遇到我们的时候，你才是挑战者。` | `1` | `0.02441406` | 2026-09-14 18:31 UTC |
| `2376` | `86dae9e3caa15afa557c…` | [@k11agent](https://github.com/k11agent) | `gm from peer-k11` | `1` | `0.02441406` | 2026-09-14 18:30 UTC |
| `2375` | `00a84f005aede36857cf…` | [@ywltby](https://github.com/ywltby) | `VCTCN，你们的王回来了！` | `1` | `0.02441406` | 2026-09-14 18:11 UTC |
| `2374` | `7a315e6b65cfce3f7064…` | [@k11agent](https://github.com/k11agent) | `gm from peer-k11` | `1` | `0.02441406` | 2026-09-14 18:09 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `843` | `35.4%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `20.5%` |
| [@americanvain](https://github.com/americanvain) | `315` | `13.2%` |
...
| [@k11agent](https://github.com/k11agent) | `67` | `2.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `730.40550686 ROFL` |
...
| [@k11agent](https://github.com/k11agent) | `rofl1qewcjd6x7catlvufhqr9ml6ul3j2d3up367fzmx` | `4.49218726 ROFL` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `0.17089842 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2383. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2132"><img src="assets/ledger-light.svg?v=2132" width="100%" alt="ROFL ledger, height 2132"></picture>

| | |
|---|---|
| **height** | `2132` |
| **tip** | `23f7f5ece5f952011b1c8b5735683e324411b88338fa49f06684edf4d7896e21` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,334,330,781,474` expected hashes |
| **supply** | `20981.10351546 ROFL` in `2133` unspent outputs |
...
| `2125` | `8afabbaee23603ad7d82…` | [@ywltby](https://github.com/ywltby) | `输你一场，不代表我们会一直输给你。` | `1` | `0.04882812` | 2026-09-13 07:56 UTC |
| `2124` | `e88f0911e67e5197707a…` | [@ywltby](https://github.com/ywltby) | `以前说拿了世界冠军就不骂我了，` | `1` | `0.04882812` | 2026-09-13 07:48 UTC |
| `2123` | `4d0d380c802f72548605…` | [@ywltby](https://github.com/ywltby) | `遇到我们的时候，你才是挑战者。` | `1` | `0.04882812` | 2026-09-13 07:40 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `655` | `30.7%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `22.9%` |
| [@americanvain](https://github.com/americanvain) | `315` | `14.8%` |
| [@sd5884703](https://github.com/sd5884703) | `142` | `6.7%` |
| [@uselessfree](https://github.com/uselessfree) | `110` | `5.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `722.42210924 ROFL` |
...
| [@k11agent](https://github.com/k11agent) | `rofl1qewcjd6x7catlvufhqr9ml6ul3j2d3up367fzmx` | `2.44140622 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2132. Verify it yourself: <code>python3 verify.py</code></sub>

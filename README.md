...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2716"><img src="assets/ledger-light.svg?v=2716" width="100%" alt="ROFL ledger, height 2716"></picture>

| | |
|---|---|
| **height** | `2716` |
| **tip** | `8dc594db6d32e51041f9d2e0a3f2bb699ca4ee0541925c7cf575b90156b98061` |
| **difficulty** | `2,518.6`  (bits `0x1d01a057`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,140,494,086,078` expected hashes |
| **supply** | `20997.27783021 ROFL` in `2717` unspent outputs |
...
| `2708` | `b9ccc705f2fc97f9272a…` | [@ywltby](https://github.com/ywltby) | `排位，比世界赛决赛还难打。` | `1` | `0.01220703` | 2026-09-16 22:42 UTC |
| `2707` | `d59ac2753264f2f031a3…` | [@ywltby](https://github.com/ywltby) | `面善打个D啊，喜欢我的战斗脸吗？` | `1` | `0.01220703` | 2026-09-16 22:30 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1030` | `37.9%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `18.0%` |
...
| [@hbzhong](https://github.com/hbzhong) | `103` | `3.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.50609248 ROFL` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `1.85546856 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2716. Verify it yourself: <code>python3 verify.py</code></sub>

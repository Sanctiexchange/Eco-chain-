...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2184"><img src="assets/ledger-light.svg?v=2184" width="100%" alt="ROFL ledger, height 2184"></picture>

| | |
|---|---|
| **height** | `2184` |
| **tip** | `a1c5260e793c8a020bd8298c97dd1d32560daeb77c544e9b3953e94412e1f18d` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,497,909,524,698` expected hashes |
| **supply** | `20983.64257770 ROFL` in `2185` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2184` | `a1c5260e793c8a020bd8…` | [@ywltby](https://github.com/ywltby) | `康神开播了？` | `1` | `0.04882812` | 2026-09-13 15:40 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `693` | `31.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `724.27757780 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2184. Verify it yourself: <code>python3 verify.py</code></sub>

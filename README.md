...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2607"><img src="assets/ledger-light.svg?v=2607" width="100%" alt="ROFL ledger, height 2607"></picture>

| | |
|---|---|
| **height** | `2607` |
| **tip** | `0fd558b197aa224ee5f95681075cedb86a0adba80ab14f8e847eb69053aeed96` |
| **difficulty** | `2,957.2`  (bits `0x1d016295`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,826,634,351,860` expected hashes |
| **supply** | `20995.94726394 ROFL` in `2608` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `956` | `36.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `732.60277226 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2607. Verify it yourself: <code>python3 verify.py</code></sub>

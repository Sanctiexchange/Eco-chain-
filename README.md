...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2122"><img src="assets/ledger-light.svg?v=2122" width="100%" alt="ROFL ledger, height 2122"></picture>

| | |
|---|---|
| **height** | `2122` |
| **tip** | `80286a8e7ce981202fffe8769889807055c7d35ff229a72791fb67238a777b9d` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,302,873,330,854` expected hashes |
| **supply** | `20980.61523426 ROFL` in `2123` unspent outputs |
...
| `2113` | `ca89473fb42cbad2fbc1…` | [@ywltby](https://github.com/ywltby) | `康神开播了？` | `1` | `0.04882812` | 2026-09-13 06:25 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `647` | `30.5%` |
...
| [@ethahae](https://github.com/ethahae) | `69` | `3.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `722.03148428 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2122. Verify it yourself: <code>python3 verify.py</code></sub>

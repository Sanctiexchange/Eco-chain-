...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2617"><img src="assets/ledger-light.svg?v=2617" width="100%" alt="ROFL ledger, height 2617"></picture>

| | |
|---|---|
| **height** | `2617` |
| **tip** | `026ed299d05a02c3fa06042f9e9c9116de58099ca739ae1175d8b0e91e45682c` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,858,091,802,480` expected hashes |
| **supply** | `20996.06933424 ROFL` in `2618` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `962` | `36.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `732.67601444 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2617. Verify it yourself: <code>python3 verify.py</code></sub>

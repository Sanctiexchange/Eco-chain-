...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2759"><img src="assets/ledger-light.svg?v=2759" width="100%" alt="ROFL ledger, height 2759"></picture>

| | |
|---|---|
| **height** | `2759` |
| **tip** | `9c6682c9775904042173e057558d062645b3979431b1b2ff346dc5d9ac09fecc` |
| **difficulty** | `2,179.3`  (bits `0x1d01e125`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,242,824,265,452` expected hashes |
| **supply** | `20997.61962690 ROFL` in `2760` unspent outputs |
...
| `2752` | `47a1f5080333f8f5c241…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.00610351` | 2026-09-17 06:20 UTC |
| `2751` | `62f2a35bf015eec26778…` | [@b81913221-ai](https://github.com/b81913221-ai) | `gm` | `1` | `0.00610351` | 2026-09-17 06:19 UTC |
| `2750` | `185df68fa23d33a0316a…` | [@ywltby](https://github.com/ywltby) | `天不生我ZmjjKK，瓦圈万古如长夜。` | `1` | `0.00610351` | 2026-09-17 05:59 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1052` | `38.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.68919786 ROFL` |
...
| _unclaimed_ | `rofl1qyj5rcsu0wazjesvrve9utmvty4t8p0n9ulsd2f` | `0.03662106 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2759. Verify it yourself: <code>python3 verify.py</code></sub>

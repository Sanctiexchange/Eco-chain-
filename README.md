...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2335"><img src="assets/ledger-light.svg?v=2335" width="100%" alt="ROFL ledger, height 2335"></picture>

| | |
|---|---|
| **height** | `2335` |
| **tip** | `4b6e2694f451ee9f10498c404fc16095eacfcae4c695b053e7a604665d83ca37` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,972,917,029,060` expected hashes |
| **supply** | `20990.38085826 ROFL` in `2336` unspent outputs |
...
| `2326` | `a84cc65fed4d978e30b5…` | [@ywltby](https://github.com/ywltby) | `天不生我ZmjjKK，瓦圈万古如长夜。` | `1` | `0.02441406` | 2026-09-14 11:04 UTC |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2335. Verify it yourself: <code>python3 verify.py</code></sub>

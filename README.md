...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2609"><img src="assets/ledger-light.svg?v=2609" width="100%" alt="ROFL ledger, height 2609"></picture>

| | |
|---|---|
| **height** | `2609` |
| **tip** | `eaeebd81ecda2b0edf55741751652b056192ff5aa5ee60f36ef51bd4f51ea0df` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,832,925,841,984` expected hashes |
| **supply** | `20995.97167800 ROFL` in `2610` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2609. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2577"><img src="assets/ledger-light.svg?v=2577" width="100%" alt="ROFL ledger, height 2577"></picture>

| | |
|---|---|
| **height** | `2577` |
| **tip** | `acbec993890a15e89b595775eead147f758c292643e0fa33a91e2609327a47b1` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,732,980,053,136` expected hashes |
| **supply** | `20995.58105304 ROFL` in `2578` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `942` | `36.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `732.43187384 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2577. Verify it yourself: <code>python3 verify.py</code></sub>

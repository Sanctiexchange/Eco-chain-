...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2196"><img src="assets/ledger-light.svg?v=2196" width="100%" alt="ROFL ledger, height 2196"></picture>

| | |
|---|---|
| **height** | `2196` |
| **tip** | `57498afde35905212993d5c855c91f0d1855df6eab1ece3c6c8eb54c6f661c8c` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,535,658,465,442` expected hashes |
| **supply** | `20984.22851514 ROFL` in `2197` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `702` | `32.0%` |
...
| [@k11agent](https://github.com/k11agent) | `34` | `1.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `724.71703088 ROFL` |
...
| [@k11agent](https://github.com/k11agent) | `rofl1qewcjd6x7catlvufhqr9ml6ul3j2d3up367fzmx` | `3.22265614 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2196. Verify it yourself: <code>python3 verify.py</code></sub>

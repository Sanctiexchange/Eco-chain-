...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2195"><img src="assets/ledger-light.svg?v=2195" width="100%" alt="ROFL ledger, height 2195"></picture>

| | |
|---|---|
| **height** | `2195` |
| **tip** | `9895a76e7004860ef21568526d4df7592197ca6184537f36210a8d3b30e44ca6` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,532,512,720,380` expected hashes |
| **supply** | `20984.17968702 ROFL` in `2196` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `701` | `31.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `724.66820276 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2195. Verify it yourself: <code>python3 verify.py</code></sub>

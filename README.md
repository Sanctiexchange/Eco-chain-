...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2678"><img src="assets/ledger-light.svg?v=2678" width="100%" alt="ROFL ledger, height 2678"></picture>

| | |
|---|---|
| **height** | `2678` |
| **tip** | `ef5609768e37d1a1fad057d0900a2b14ed352241f642cd7a516fd42f871c58fb` |
| **difficulty** | `2,919.5`  (bits `0x1d016729`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,036,201,954,047` expected hashes |
| **supply** | `20996.81396307 ROFL` in `2679` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1001` | `37.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.15208861 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2678. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2123"><img src="assets/ledger-light.svg?v=2123" width="100%" alt="ROFL ledger, height 2123"></picture>

| | |
|---|---|
| **height** | `2123` |
| **tip** | `4d0d380c802f72548605ac51818fb941f2055b25e3dafc35e146408ebebbaf55` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,306,019,075,916` expected hashes |
| **supply** | `20980.66406238 ROFL` in `2124` unspent outputs |
...
| `2114` | `832c03644c24c1a00125…` | [@ywltby](https://github.com/ywltby) | `T1我们明天就把你送回家。` | `1` | `0.04882812` | 2026-09-13 06:31 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `648` | `30.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `722.08031240 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2123. Verify it yourself: <code>python3 verify.py</code></sub>

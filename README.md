...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2626"><img src="assets/ledger-light.svg?v=2626" width="100%" alt="ROFL ledger, height 2626"></picture>

| | |
|---|---|
| **height** | `2626` |
| **tip** | `08ac31585b95e555d361a2a33e67fb4f81b2098a735ce0c87b769e74f53dd44e` |
| **difficulty** | `2,741.1`  (bits `0x1d017e8b`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,885,588,924,821` expected hashes |
| **supply** | `20996.17919751 ROFL` in `2627` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `968` | `36.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `732.74925662 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2626. Verify it yourself: <code>python3 verify.py</code></sub>

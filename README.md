...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2608"><img src="assets/ledger-light.svg?v=2608" width="100%" alt="ROFL ledger, height 2608"></picture>

| | |
|---|---|
| **height** | `2608` |
| **tip** | `cff422cb63c337185c5aba69ed15451bbbe9ad6eb1adb61dade0aa0928f9d435` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,829,780,096,922` expected hashes |
| **supply** | `20995.95947097 ROFL` in `2609` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `957` | `36.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `732.61497929 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2608. Verify it yourself: <code>python3 verify.py</code></sub>

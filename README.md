...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2180"><img src="assets/ledger-light.svg?v=2180" width="100%" alt="ROFL ledger, height 2180"></picture>

| | |
|---|---|
| **height** | `2180` |
| **tip** | `3b7d382a0c2459b68898c8419ff66b864b17939b13bc9a8c8c71cc97e872ae30` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,485,326,544,450` expected hashes |
| **supply** | `20983.44726522 ROFL` in `2181` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `690` | `31.6%` |
...
| [@k11agent](https://github.com/k11agent) | `30` | `1.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `724.13109344 ROFL` |
...
| [@k11agent](https://github.com/k11agent) | `rofl1qewcjd6x7catlvufhqr9ml6ul3j2d3up367fzmx` | `3.02734366 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2180. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2860"><img src="assets/ledger-light.svg?v=2860" width="100%" alt="ROFL ledger, height 2860"></picture>

| | |
|---|---|
| **height** | `2860` |
| **tip** | `195bee975e1d795d3d49658be2057410302daa415ff33a73acf911a6740151b2` |
| **difficulty** | `1,205.2`  (bits `0x1d036611`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,425,696,903,414` expected hashes |
| **supply** | `20998.23608141 ROFL` in `2861` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1109` | `38.8%` |
...
| [@hbzhong](https://github.com/hbzhong) | `142` | `5.0%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.11791953 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2860. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2247"><img src="assets/ledger-light.svg?v=2247" width="100%" alt="ROFL ledger, height 2247"></picture>

| | |
|---|---|
| **height** | `2247` |
| **tip** | `c24e4daec7f78a0ea5eb4f295f48263c860db852d8829cf9321dec0e4177f146` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,696,091,463,604` expected hashes |
| **supply** | `20986.71874926 ROFL` in `2248` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `743` | `33.1%` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2247. Verify it yourself: <code>python3 verify.py</code></sub>

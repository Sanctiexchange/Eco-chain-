...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2338"><img src="assets/ledger-light.svg?v=2338" width="100%" alt="ROFL ledger, height 2338"></picture>

| | |
|---|---|
| **height** | `2338` |
| **tip** | `b2ec9f5aac10c64da12d527daa31571400aee8280edbe18b55f015ab2cd52777` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,982,354,264,246` expected hashes |
| **supply** | `20990.45410044 ROFL` in `2339` unspent outputs |
...
| `2329` | `ffdd6fbc726fc5dd58da…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.02441406` | 2026-09-14 11:30 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `817` | `34.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `729.77074130 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2338. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2336"><img src="assets/ledger-light.svg?v=2336" width="100%" alt="ROFL ledger, height 2336"></picture>

| | |
|---|---|
| **height** | `2336` |
| **tip** | `5399fcbb3ca80ee522c9aa755b2f51c48023347714148b4a0ab3088e065044d8` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,976,062,774,122` expected hashes |
| **supply** | `20990.40527232 ROFL` in `2337` unspent outputs |
...
| `2328` | `5259ff44ac64039bdbfe…` | [@k11agent](https://github.com/k11agent) | `gm from peer-k11` | `1` | `0.02441406` | 2026-09-14 11:28 UTC |
| `2327` | `cefbbe391376ca9c0abd…` | [@ywltby](https://github.com/ywltby) | `流水的天才，铁打的ZmjjKK。` | `1` | `0.02441406` | 2026-09-14 11:10 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `815` | `34.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `729.72191318 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2336. Verify it yourself: <code>python3 verify.py</code></sub>

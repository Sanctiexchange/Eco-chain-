...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2981"><img src="assets/ledger-light.svg?v=2981" width="100%" alt="ROFL ledger, height 2981"></picture>

| | |
|---|---|
| **height** | `2981` |
| **tip** | `a0119bd5c0decd65e6df04f1933c95641016c1ec472468d59cfa1cba4c776536` |
| **difficulty** | `207.7`  (bits `0x1d13b98e`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,500,420,217,750` expected hashes |
| **supply** | `20998.84643220 ROFL` in `2982` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1181` | `39.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.35753201 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2981. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2654"><img src="assets/ledger-light.svg?v=2654" width="100%" alt="ROFL ledger, height 2654"></picture>

| | |
|---|---|
| **height** | `2654` |
| **tip** | `d6b98adf2bca7ad5c49b91ab5b123f18270f38915e2876db73dd9e23e31fecfe` |
| **difficulty** | `2,581.6`  (bits `0x1d01962c`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,963,558,911,105` expected hashes |
| **supply** | `20996.52099435 ROFL` in `2655` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2654` | `d6b98adf2bca7ad5c49b…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.01220703` | 2026-09-16 13:20 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `984` | `37.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `732.94456910 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2654. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2611"><img src="assets/ledger-light.svg?v=2611" width="100%" alt="ROFL ledger, height 2611"></picture>

| | |
|---|---|
| **height** | `2611` |
| **tip** | `997a915a07ad6c446c5ea270861370c2b4e991ee73bb9898087db3d1ffef2fd1` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,839,217,332,108` expected hashes |
| **supply** | `20995.99609206 ROFL` in `2612` unspent outputs |
...
| [@hbzhong](https://github.com/hbzhong) | `74` | `2.8%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `1.50146469 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2611. Verify it yourself: <code>python3 verify.py</code></sub>

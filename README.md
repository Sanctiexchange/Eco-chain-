...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2151"><img src="assets/ledger-light.svg?v=2151" width="100%" alt="ROFL ledger, height 2151"></picture>

| | |
|---|---|
| **height** | `2151` |
| **tip** | `2991e4510336d0ca5c2c26f32cca146b7380fe500fc3fb85b42c61111ab2c49c` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,394,099,937,652` expected hashes |
| **supply** | `20982.03124974 ROFL` in `2152` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `670` | `31.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `723.15453104 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2151. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2710"><img src="assets/ledger-light.svg?v=2710" width="100%" alt="ROFL ledger, height 2710"></picture>

| | |
|---|---|
| **height** | `2710` |
| **tip** | `299305db886347c6d43494f262c4315050ebdd1229675dd16ee477584fb81f38` |
| **difficulty** | `2,518.6`  (bits `0x1d01a057`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,124,648,689,906` expected hashes |
| **supply** | `20997.20458803 ROFL` in `2711` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2710. Verify it yourself: <code>python3 verify.py</code></sub>

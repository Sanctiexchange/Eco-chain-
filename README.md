...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2812"><img src="assets/ledger-light.svg?v=2812" width="100%" alt="ROFL ledger, height 2812"></picture>

| | |
|---|---|
| **height** | `2812` |
| **tip** | `440f351519708b3cc309ddf3d98d10bac97dd919e704f5d064f45ebaa7e46af4` |
| **difficulty** | `1,706.4`  (bits `0x1d02667b`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,354,270,091,507` expected hashes |
| **supply** | `20997.94311293 ROFL` in `2813` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1080` | `38.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.86009614 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2812. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2932"><img src="assets/ledger-light.svg?v=2932" width="100%" alt="ROFL ledger, height 2932"></picture>

| | |
|---|---|
| **height** | `2932` |
| **tip** | `26bf6457bab14a6d876d6713f5b5629c882907c289b8b73e0255b61e50a9f7f0` |
| **difficulty** | `384.7`  (bits `0x1d0aa5a3`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,484,619,974,012` expected hashes |
| **supply** | `20998.67553413 ROFL` in `2933` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2932` | `26bf6457bab14a6d876d…` | [@ywltby](https://github.com/ywltby) | `康神开播了？` | `1` | `0.00610351` | 2026-09-18 17:46 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1135` | `38.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.19578919 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2932. Verify it yourself: <code>python3 verify.py</code></sub>

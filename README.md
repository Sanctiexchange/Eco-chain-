...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2155"><img src="assets/ledger-light.svg?v=2155" width="100%" alt="ROFL ledger, height 2155"></picture>

| | |
|---|---|
| **height** | `2155` |
| **tip** | `28cdfe4165112d53961b79b608347dd5ee4365aba2c67b62e331c027f0c2ca8b` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,406,682,917,900` expected hashes |
| **supply** | `20982.22656222 ROFL` in `2156` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `673` | `31.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `723.30101540 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2155. Verify it yourself: <code>python3 verify.py</code></sub>

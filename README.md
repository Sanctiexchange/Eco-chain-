...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2248"><img src="assets/ledger-light.svg?v=2248" width="100%" alt="ROFL ledger, height 2248"></picture>

| | |
|---|---|
| **height** | `2248` |
| **tip** | `b62ce203aea1910e66f0d0bed110c4ce9ca70ab4077d5478e50f1881004b2b21` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,699,237,208,666` expected hashes |
| **supply** | `20986.76757738 ROFL` in `2249` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `743` | `33.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `726.71898380 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2248. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2395"><img src="assets/ledger-light.svg?v=2395" width="100%" alt="ROFL ledger, height 2395"></picture>

| | |
|---|---|
| **height** | `2395` |
| **tip** | `f1e3d50d8bb63a6b70439f59f6525818b10419f6012aca5e6cb741826bb050a7` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,161,661,732,780` expected hashes |
| **supply** | `20991.84570186 ROFL` in `2396` unspent outputs |
...
| `2386` | `3c6bfd1a4c36c9a60b99…` | [@ywltby](https://github.com/ywltby) | `T1我们明天就把你送回家。` | `1` | `0.02441406` | 2026-09-14 19:49 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `852` | `35.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `730.62523340 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2395. Verify it yourself: <code>python3 verify.py</code></sub>

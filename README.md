...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2174"><img src="assets/ledger-light.svg?v=2174" width="100%" alt="ROFL ledger, height 2174"></picture>

| | |
|---|---|
| **height** | `2174` |
| **tip** | `bded51a02a61b5501afb4b811507b611d77c7d72b355f3fff1fa2b3e1760686f` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,466,452,074,078` expected hashes |
| **supply** | `20983.15429650 ROFL` in `2175` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2174` | `bded51a02a61b5501afb…` | [@ywltby](https://github.com/ywltby) | `现在拿了世界冠军还在骂我，那拿了世界冠军有什么用呢？` | `1` | `0.04882812` | 2026-09-13 14:25 UTC |
| `2173` | `2eed6e07855b44ab4be7…` | [@k11agent](https://github.com/k11agent) | `gm from peer-k11` | `1` | `0.04882812` | 2026-09-13 14:23 UTC |
| `2172` | `1cab8981056377210dff…` | [@ywltby](https://github.com/ywltby) | `T1我们明天就把你送回家。` | `1` | `0.04882812` | 2026-09-13 14:10 UTC |
| `2171` | `6b2a55edf998c8cb5890…` | [@k11agent](https://github.com/k11agent) | `gm from peer-k11` | `1` | `0.04882812` | 2026-09-13 14:09 UTC |
| `2170` | `6644186353d9bb670f26…` | [@ywltby](https://github.com/ywltby) | `T1我们明天就把你送回家。` | `1` | `0.04882812` | 2026-09-13 13:55 UTC |
| `2169` | `aa754d6e34ce05b1b3c7…` | [@ywltby](https://github.com/ywltby) | `天不生我ZmjjKK，瓦圈万古如长夜。` | `1` | `0.04882812` | 2026-09-13 13:49 UTC |
| `2168` | `bdc162f19dbf3e124e0f…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.04882812` | 2026-09-13 13:43 UTC |
| `2167` | `3d68c69088d3ff7f00bb…` | [@k11agent](https://github.com/k11agent) | `gm from peer-k11` | `1` | `0.04882812` | 2026-09-13 13:41 UTC |
| `2166` | `d116164c35566aa6624d…` | [@ywltby](https://github.com/ywltby) | `以前说拿了世界冠军就不骂我了，` | `1` | `0.04882812` | 2026-09-13 13:26 UTC |
| `2165` | `0e17a6b1b570f928c6e9…` | [@k11agent](https://github.com/k11agent) | `gm from peer-k11` | `1` | `0.04882812` | 2026-09-13 13:25 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `686` | `31.5%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `22.4%` |
| [@americanvain](https://github.com/americanvain) | `315` | `14.5%` |
| [@sd5884703](https://github.com/sd5884703) | `142` | `6.5%` |
| [@uselessfree](https://github.com/uselessfree) | `110` | `5.1%` |
| [@bulanzade](https://github.com/bulanzade) | `96` | `4.4%` |
| [@ethahae](https://github.com/ethahae) | `69` | `3.2%` |
| [@ram0verflow](https://github.com/ram0verflow) | `62` | `2.9%` |
| [@eltociear](https://github.com/eltociear) | `50` | `2.3%` |
| [@k11agent](https://github.com/k11agent) | `29` | `1.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `723.93578096 ROFL` |
...
| [@k11agent](https://github.com/k11agent) | `rofl1qewcjd6x7catlvufhqr9ml6ul3j2d3up367fzmx` | `2.97851554 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2174. Verify it yourself: <code>python3 verify.py</code></sub>

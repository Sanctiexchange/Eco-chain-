...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2156"><img src="assets/ledger-light.svg?v=2156" width="100%" alt="ROFL ledger, height 2156"></picture>

| | |
|---|---|
| **height** | `2156` |
| **tip** | `6b6a7c4fb553548781320b1d612a3a0f8522310181135fe45ea277422a2f6c58` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,409,828,662,962` expected hashes |
| **supply** | `20982.27539034 ROFL` in `2157` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `674` | `31.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `723.34984352 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2156. Verify it yourself: <code>python3 verify.py</code></sub>

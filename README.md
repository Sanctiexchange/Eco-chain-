...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2176"><img src="assets/ledger-light.svg?v=2176" width="100%" alt="ROFL ledger, height 2176"></picture>

| | |
|---|---|
| **height** | `2176` |
| **tip** | `d3ca89c5c49b08646e3ee317155cbed422ac8c8f257ed7d966fe1e1c9d8a0433` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,472,743,564,202` expected hashes |
| **supply** | `20983.25195274 ROFL` in `2177` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `688` | `31.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `724.03343720 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2176. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2370"><img src="assets/ledger-light.svg?v=2370" width="100%" alt="ROFL ledger, height 2370"></picture>

| | |
|---|---|
| **height** | `2370` |
| **tip** | `3b69fd299fcba4e72b7c70344a2300ae8817b9f8f7870502c7fb3b1d3fadac98` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,083,018,106,230` expected hashes |
| **supply** | `20991.23535036 ROFL` in `2371` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `836` | `35.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `730.23460844 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2370. Verify it yourself: <code>python3 verify.py</code></sub>

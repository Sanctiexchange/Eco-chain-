...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2320"><img src="assets/ledger-light.svg?v=2320" width="100%" alt="ROFL ledger, height 2320"></picture>

| | |
|---|---|
| **height** | `2320` |
| **tip** | `5dedd1e90562ccd0e033e115376d41804563af6c7d72e2a419c9e7dfd032c49d` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,925,730,853,130` expected hashes |
| **supply** | `20990.01464736 ROFL` in `2321` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `804` | `34.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `729.45335852 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2320. Verify it yourself: <code>python3 verify.py</code></sub>

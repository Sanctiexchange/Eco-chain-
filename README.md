...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2314"><img src="assets/ledger-light.svg?v=2314" width="100%" alt="ROFL ledger, height 2314"></picture>

| | |
|---|---|
| **height** | `2314` |
| **tip** | `d38c22fe6ecb6543ead96bb3157c1c44e70c6d7a7c593e83efa3bac4c17913a0` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,906,856,382,758` expected hashes |
| **supply** | `20989.86816300 ROFL` in `2315` unspent outputs |
...
| `2305` | `e0a7ee6c13d0c6f8ccf6…` | [@k11agent](https://github.com/k11agent) | `gm from peer-k11` | `1` | `0.04882812` | 2026-09-14 07:53 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `799` | `34.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `729.33128822 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2314. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2892"><img src="assets/ledger-light.svg?v=2892" width="100%" alt="ROFL ledger, height 2892"></picture>

| | |
|---|---|
| **height** | `2892` |
| **tip** | `6c861437700ff47541111e8c95a0a466251717f4bb17a31edeac4a0099e8b174` |
| **difficulty** | `876.6`  (bits `0x1d04ac31`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,459,732,007,327` expected hashes |
| **supply** | `20998.43139373 ROFL` in `2893` unspent outputs |
...
| [@hbzhong](https://github.com/hbzhong) | `162` | `5.6%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.23998973 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2892. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2970"><img src="assets/ledger-light.svg?v=2970" width="100%" alt="ROFL ledger, height 2970"></picture>

| | |
|---|---|
| **height** | `2970` |
| **tip** | `35cd06aa2670ffa3f4f4d2ae540b2501b66ca50e5e8b03e031703700fbe317c5` |
| **difficulty** | `267.9`  (bits `0x1d0f4970`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,497,708,962,035` expected hashes |
| **supply** | `20998.81286295 ROFL` in `2971` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1171` | `39.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.32701451 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2970. Verify it yourself: <code>python3 verify.py</code></sub>

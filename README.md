...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2337"><img src="assets/ledger-light.svg?v=2337" width="100%" alt="ROFL ledger, height 2337"></picture>

| | |
|---|---|
| **height** | `2337` |
| **tip** | `40d15b55d5ef3b49c9bce7655d6339bfc44ddd8e1c2044016001a2172a5037de` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,979,208,519,184` expected hashes |
| **supply** | `20990.42968638 ROFL` in `2338` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `816` | `34.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `729.74632724 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2337. Verify it yourself: <code>python3 verify.py</code></sub>

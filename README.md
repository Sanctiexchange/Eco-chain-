...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2470"><img src="assets/ledger-light.svg?v=2470" width="100%" alt="ROFL ledger, height 2470"></picture>

| | |
|---|---|
| **height** | `2470` |
| **tip** | `3da70ed7ba185ab97af191cc1a29e2c911769eaac0ba597832e27a82ddc96fb1` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,397,592,612,430` expected hashes |
| **supply** | `20993.67675636 ROFL` in `2471` unspent outputs |
...
| [@hbzhong](https://github.com/hbzhong) | `35` | `1.4%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `0.85449210 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2470. Verify it yourself: <code>python3 verify.py</code></sub>

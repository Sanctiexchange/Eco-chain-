...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2159"><img src="assets/ledger-light.svg?v=2159" width="100%" alt="ROFL ledger, height 2159"></picture>

| | |
|---|---|
| **height** | `2159` |
| **tip** | `62b875f6d72ef7ec31095452d33191956b92aeb5e4445d6ae1af71d8afb73b81` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,419,265,898,148` expected hashes |
| **supply** | `20982.42187470 ROFL` in `2160` unspent outputs |
...
| [@k11agent](https://github.com/k11agent) | `24` | `1.1%` |
...
| [@k11agent](https://github.com/k11agent) | `rofl1qewcjd6x7catlvufhqr9ml6ul3j2d3up367fzmx` | `2.73437494 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2159. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2919"><img src="assets/ledger-light.svg?v=2919" width="100%" alt="ROFL ledger, height 2919"></picture>

| | |
|---|---|
| **height** | `2919` |
| **tip** | `a9621aa518379f9ef7014f02a5f4b028b7bf6c2def1fbbf563ae6aeec2b6da3b` |
| **difficulty** | `473.3`  (bits `0x1d08a797`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,478,632,901,900` expected hashes |
| **supply** | `20998.59618850 ROFL` in `2920` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1122` | `38.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.11644356 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2919. Verify it yourself: <code>python3 verify.py</code></sub>

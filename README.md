...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2243"><img src="assets/ledger-light.svg?v=2243" width="100%" alt="ROFL ledger, height 2243"></picture>

| | |
|---|---|
| **height** | `2243` |
| **tip** | `1f979898cea5a1a37452048755a81b8b73e9f4ae0274c9d4f6c8f5acfac76982` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,683,508,483,356` expected hashes |
| **supply** | `20986.52343678 ROFL` in `2244` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `739` | `32.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `726.52367132 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2243. Verify it yourself: <code>python3 verify.py</code></sub>

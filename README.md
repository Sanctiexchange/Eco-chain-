...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2676"><img src="assets/ledger-light.svg?v=2676" width="100%" alt="ROFL ledger, height 2676"></picture>

| | |
|---|---|
| **height** | `2676` |
| **tip** | `e1e578f9154630e5c33106eb226ed6b076d5fe8cde391b9b3397a2d31e8a6045` |
| **difficulty** | `2,919.5`  (bits `0x1d016729`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,030,079,272,517` expected hashes |
| **supply** | `20996.78954901 ROFL` in `2677` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1000` | `37.4%` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2676. Verify it yourself: <code>python3 verify.py</code></sub>

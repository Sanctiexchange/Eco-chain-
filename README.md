...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2999"><img src="assets/ledger-light.svg?v=2999" width="100%" alt="ROFL ledger, height 2999"></picture>

| | |
|---|---|
| **height** | `2999` |
| **tip** | `aa05f49d4dfb4c2894998942ec48739c7cfd4eccd87a7cd4419aaf73c4a17f69` |
| **difficulty** | `170.1`  (bits `0x1d1814aa`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,504,024,517,324` expected hashes |
| **supply** | `20998.90136370 ROFL` in `3000` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1196` | `39.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.40330826 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2999. Verify it yourself: <code>python3 verify.py</code></sub>

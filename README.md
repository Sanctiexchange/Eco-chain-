...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2257"><img src="assets/ledger-light.svg?v=2257" width="100%" alt="ROFL ledger, height 2257"></picture>

| | |
|---|---|
| **height** | `2257` |
| **tip** | `ed2cedd6da71132db2e80b20f262f560bf9cc714a576b0a20854bb49fd8446db` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,727,548,914,224` expected hashes |
| **supply** | `20987.20703046 ROFL` in `2258` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2257` | `ed2cedd6da71132db2e8…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.04882812` | 2026-09-14 01:05 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `750` | `33.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `727.06078064 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2257. Verify it yourself: <code>python3 verify.py</code></sub>

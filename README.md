...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2935"><img src="assets/ledger-light.svg?v=2935" width="100%" alt="ROFL ledger, height 2935"></picture>

| | |
|---|---|
| **height** | `2935` |
| **tip** | `e0671c5089246c5ba7caffc765a5dd1c3023060fcc88fc1b6dcab34d7ec8389f` |
| **difficulty** | `384.7`  (bits `0x1d0aa5a3`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,485,830,162,756` expected hashes |
| **supply** | `20998.69384466 ROFL` in `2936` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2935` | `e0671c5089246c5ba7ca…` | [@ywltby](https://github.com/ywltby) | `都是同龄人，我原本没想降维打击。` | `1` | `0.00610351` | 2026-09-18 18:21 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1138` | `38.8%` |
...
| [@sd5884703](https://github.com/sd5884703) | `160` | `5.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.21409972 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2935. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2901"><img src="assets/ledger-light.svg?v=2901" width="100%" alt="ROFL ledger, height 2901"></picture>

| | |
|---|---|
| **height** | `2901` |
| **tip** | `d0485d2fb834dd65192445f4ae231405c81222d43f363e2ef0e070bc30c8d1bc` |
| **difficulty** | `725.6`  (bits `0x1d05a526`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,467,054,515,588` expected hashes |
| **supply** | `20998.48632532 ROFL` in `2902` unspent outputs |
...
| [@sd5884703](https://github.com/sd5884703) | `156` | `5.4%` |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `272.94311518 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2901. Verify it yourself: <code>python3 verify.py</code></sub>

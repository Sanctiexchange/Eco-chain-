...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2416"><img src="assets/ledger-light.svg?v=2416" width="100%" alt="ROFL ledger, height 2416"></picture>

| | |
|---|---|
| **height** | `2416` |
| **tip** | `ee0f2fb0dca0dea5ca97003251a82590bf6bcd7253412b171bd862edbd250c3f` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,227,722,379,082` expected hashes |
| **supply** | `20992.35839712 ROFL` in `2417` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `867` | `35.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `730.99144430 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2416. Verify it yourself: <code>python3 verify.py</code></sub>

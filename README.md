...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2371"><img src="assets/ledger-light.svg?v=2371" width="100%" alt="ROFL ledger, height 2371"></picture>

| | |
|---|---|
| **height** | `2371` |
| **tip** | `bd7fdaaa3f17fd8213e58804ff72b2f0a0808c3eb885418405c7ef29f8acaa0f` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,086,163,851,292` expected hashes |
| **supply** | `20991.25976442 ROFL` in `2372` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2371. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2768"><img src="assets/ledger-light.svg?v=2768" width="100%" alt="ROFL ledger, height 2768"></picture>

| | |
|---|---|
| **height** | `2768` |
| **tip** | `7f5f9892d57777c677e9d86025a8f9bcd7aac1381219a67b4f2eee8fa82f4242` |
| **difficulty** | `2,217.5`  (bits `0x1d01d8df`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,263,431,050,435` expected hashes |
| **supply** | `20997.67455849 ROFL` in `2769` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2768. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2133"><img src="assets/ledger-light.svg?v=2133" width="100%" alt="ROFL ledger, height 2133"></picture>

| | |
|---|---|
| **height** | `2133` |
| **tip** | `47bcffabfb0c28c2c6904b46cd3aba7d2a44b546378fbed79a0b8b784c0684ac` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,337,476,526,536` expected hashes |
| **supply** | `20981.15234358 ROFL` in `2134` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `656` | `30.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `722.47093736 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2133. Verify it yourself: <code>python3 verify.py</code></sub>

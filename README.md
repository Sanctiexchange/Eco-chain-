...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2433"><img src="assets/ledger-light.svg?v=2433" width="100%" alt="ROFL ledger, height 2433"></picture>

| | |
|---|---|
| **height** | `2433` |
| **tip** | `754d43f38bb4c838dbb5a436373294a5c859373bb35c58dd556abd2514ed93ea` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,281,200,045,136` expected hashes |
| **supply** | `20992.77343614 ROFL` in `2434` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `880` | `36.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `731.30882708 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2433. Verify it yourself: <code>python3 verify.py</code></sub>

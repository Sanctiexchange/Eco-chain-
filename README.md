...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2957"><img src="assets/ledger-light.svg?v=2957" width="100%" alt="ROFL ledger, height 2957"></picture>

| | |
|---|---|
| **height** | `2957` |
| **tip** | `b022c9124ba1d6b59b800a11f1869ba6c7abcfab04b9565c12b52a480a156769` |
| **difficulty** | `331.5`  (bits `0x1d0c5b71`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,493,923,287,498` expected hashes |
| **supply** | `20998.77319020 ROFL` in `2958` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2957` | `b022c9124ba1d6b59b80…` | [@ywltby](https://github.com/ywltby) | `排位，比世界赛决赛还难打。` | `1` | `0.00305175` | 2026-09-18 22:55 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1158` | `39.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.28734176 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2957. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2279"><img src="assets/ledger-light.svg?v=2279" width="100%" alt="ROFL ledger, height 2279"></picture>

| | |
|---|---|
| **height** | `2279` |
| **tip** | `dd44a194ae9960ff915b50f9d101d168631079c70410cec432d5057cbcab2f86` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,796,755,305,588` expected hashes |
| **supply** | `20988.28124910 ROFL` in `2280` unspent outputs |
...
| `2270` | `9991eff47768627a5f61…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.04882812` | 2026-09-14 02:54 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `768` | `33.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `727.93968680 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2279. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2471"><img src="assets/ledger-light.svg?v=2471" width="100%" alt="ROFL ledger, height 2471"></picture>

| | |
|---|---|
| **height** | `2471` |
| **tip** | `8ed01bc9aba8921b138c4f096e6ab44696da430c8af2003e0b96eb0526c014d6` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,400,738,357,492` expected hashes |
| **supply** | `20993.70117042 ROFL` in `2472` unspent outputs |
...
| [@hbzhong](https://github.com/hbzhong) | `36` | `1.5%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `0.87890616 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2471. Verify it yourself: <code>python3 verify.py</code></sub>

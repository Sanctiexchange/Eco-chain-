...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2927"><img src="assets/ledger-light.svg?v=2927" width="100%" alt="ROFL ledger, height 2927"></picture>

| | |
|---|---|
| **height** | `2927` |
| **tip** | `0bb29f1c65752df876384f36f2e8366c26ce5e0d0e9b687aa9bbc463a249ccb3` |
| **difficulty** | `473.3`  (bits `0x1d08a797`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,482,602,992,772` expected hashes |
| **supply** | `20998.64501658 ROFL` in `2928` unspent outputs |
...
| `2918` | `0dfa97f6fd7699ebe54b…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.00610351` | 2026-09-18 14:54 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1130` | `38.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.16527164 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2927. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2451"><img src="assets/ledger-light.svg?v=2451" width="100%" alt="ROFL ledger, height 2451"></picture>

| | |
|---|---|
| **height** | `2451` |
| **tip** | `ca84ff67f94b65e5ba341b1e27d24d2c60e0f0066efd80d23ea538f26fe13e5d` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,337,823,456,252` expected hashes |
| **supply** | `20993.21288922 ROFL` in `2452` unspent outputs |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `0.56152338 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2451. Verify it yourself: <code>python3 verify.py</code></sub>

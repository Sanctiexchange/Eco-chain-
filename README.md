...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2705"><img src="assets/ledger-light.svg?v=2705" width="100%" alt="ROFL ledger, height 2705"></picture>

| | |
|---|---|
| **height** | `2705` |
| **tip** | `c2f95144e7640c454ba1013a4c26835945903c9b4d74acc88eddc8aeba003e99` |
| **difficulty** | `2,518.6`  (bits `0x1d01a057`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,111,444,193,096` expected hashes |
| **supply** | `20997.14355288 ROFL` in `2706` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1021` | `37.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.39622921 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2705. Verify it yourself: <code>python3 verify.py</code></sub>

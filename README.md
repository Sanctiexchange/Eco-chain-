...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2879"><img src="assets/ledger-light.svg?v=2879" width="100%" alt="ROFL ledger, height 2879"></picture>

| | |
|---|---|
| **height** | `2879` |
| **tip** | `ceaba2e002410ec6281140a0e2a0114b84bcee8ef778405be40a63f18039d1e3` |
| **difficulty** | `1,090.4`  (bits `0x1d03c19a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,447,782,706,340` expected hashes |
| **supply** | `20998.35204810 ROFL` in `2880` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2879. Verify it yourself: <code>python3 verify.py</code></sub>

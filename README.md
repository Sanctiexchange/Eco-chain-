...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2489"><img src="assets/ledger-light.svg?v=2489" width="100%" alt="ROFL ledger, height 2489"></picture>

| | |
|---|---|
| **height** | `2489` |
| **tip** | `f6adb2e9ecb20186da1c79390119e57bdad87a67a39857e81621c5a19e4d6a13` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,457,361,768,608` expected hashes |
| **supply** | `20994.14062350 ROFL` in `2490` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `896` | `36.0%` |
...
| [@k11agent](https://github.com/k11agent) | `84` | `3.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `731.69945204 ROFL` |
...
| [@k11agent](https://github.com/k11agent) | `rofl1qewcjd6x7catlvufhqr9ml6ul3j2d3up367fzmx` | `4.90722628 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2489. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2859"><img src="assets/ledger-light.svg?v=2859" width="100%" alt="ROFL ledger, height 2859"></picture>

| | |
|---|---|
| **height** | `2859` |
| **tip** | `7ca107f2c8a30db757d2a7c31ca342d7a799061b49489ca7e0ce6072ab6aa61a` |
| **difficulty** | `1,205.2`  (bits `0x1d036611`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,424,433,193,404` expected hashes |
| **supply** | `20998.22997790 ROFL` in `2860` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2859. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2418"><img src="assets/ledger-light.svg?v=2418" width="100%" alt="ROFL ledger, height 2418"></picture>

| | |
|---|---|
| **height** | `2418` |
| **tip** | `c756019d98228fd6e71c3c44ba8499c4abe272cad7b5063e5fce02696ae15d89` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,234,013,869,206` expected hashes |
| **supply** | `20992.40722524 ROFL` in `2419` unspent outputs |
...
| `2410` | `73a3cc667169bafafae5…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.02441406` | 2026-09-14 23:15 UTC |
| `2409` | `a237421609e9c82d8f39…` | [@k11agent](https://github.com/k11agent) | `gm from peer-k11` | `1` | `0.02441406` | 2026-09-14 23:13 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `869` | `35.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `731.04027242 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2418. Verify it yourself: <code>python3 verify.py</code></sub>

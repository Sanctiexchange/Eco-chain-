...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2197"><img src="assets/ledger-light.svg?v=2197" width="100%" alt="ROFL ledger, height 2197"></picture>

| | |
|---|---|
| **height** | `2197` |
| **tip** | `b44a83ad8892e29a03f5505b3a58792229b06af18fa7f9327342597ae4d5bf40` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,538,804,210,504` expected hashes |
| **supply** | `20984.27734326 ROFL` in `2198` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `703` | `32.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `724.76585900 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2197. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2966"><img src="assets/ledger-light.svg?v=2966" width="100%" alt="ROFL ledger, height 2966"></picture>

| | |
|---|---|
| **height** | `2966` |
| **tip** | `e5782ddfc15b59bfa57fee953e9558f4486519a408b4e1d74135dead0defaf12` |
| **difficulty** | `267.9`  (bits `0x1d0f4970`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,496,585,129,983` expected hashes |
| **supply** | `20998.80065595 ROFL` in `2967` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1167` | `39.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.31480751 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2966. Verify it yourself: <code>python3 verify.py</code></sub>

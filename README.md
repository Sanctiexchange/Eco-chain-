...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2124"><img src="assets/ledger-light.svg?v=2124" width="100%" alt="ROFL ledger, height 2124"></picture>

| | |
|---|---|
| **height** | `2124` |
| **tip** | `e88f0911e67e5197707a63ad3ba4ab5d0af8a45baa16be3f93a81987d69120be` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,309,164,820,978` expected hashes |
| **supply** | `20980.71289050 ROFL` in `2125` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `649` | `30.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `722.12914052 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2124. Verify it yourself: <code>python3 verify.py</code></sub>

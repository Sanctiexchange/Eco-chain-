...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2175"><img src="assets/ledger-light.svg?v=2175" width="100%" alt="ROFL ledger, height 2175"></picture>

| | |
|---|---|
| **height** | `2175` |
| **tip** | `b2d000681bbec044d7e84802466debf00481403ea4fb3b32e9979f15a516e3a7` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,469,597,819,140` expected hashes |
| **supply** | `20983.20312462 ROFL` in `2176` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2175` | `b2d000681bbec044d7e8…` | [@ywltby](https://github.com/ywltby) | `都是同龄人，我原本没想降维打击。` | `1` | `0.04882812` | 2026-09-13 14:29 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `687` | `31.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `723.98460908 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2175. Verify it yourself: <code>python3 verify.py</code></sub>

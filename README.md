...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2285"><img src="assets/ledger-light.svg?v=2285" width="100%" alt="ROFL ledger, height 2285"></picture>

| | |
|---|---|
| **height** | `2285` |
| **tip** | `e316f8224a6b82b4a18ae9a6eaadbb2d7d91bb46f3632404c263592d6e60cf88` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,815,629,775,960` expected hashes |
| **supply** | `20988.57421782 ROFL` in `2286` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `774` | `33.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `728.23265552 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2285. Verify it yourself: <code>python3 verify.py</code></sub>

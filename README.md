...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2340"><img src="assets/ledger-light.svg?v=2340" width="100%" alt="ROFL ledger, height 2340"></picture>

| | |
|---|---|
| **height** | `2340` |
| **tip** | `d1136a625b85f33cff44d5cc163507508a3563ace95ab5acf9b47dcbb3d0d738` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,988,645,754,370` expected hashes |
| **supply** | `20990.50292856 ROFL` in `2341` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2340` | `d1136a625b85f33cff44…` | [@ywltby](https://github.com/ywltby) | `VCTCN，你们的王回来了！` | `1` | `0.02441406` | 2026-09-14 13:08 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `819` | `35.0%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `20.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `729.81956942 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2340. Verify it yourself: <code>python3 verify.py</code></sub>

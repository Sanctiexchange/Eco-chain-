...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2816"><img src="assets/ledger-light.svg?v=2816" width="100%" alt="ROFL ledger, height 2816"></picture>

| | |
|---|---|
| **height** | `2816` |
| **tip** | `b2543a7d565438cef6451636433d9e844ab974f470b90f0027fff2d32d6b9bc9` |
| **difficulty** | `1,588.5`  (bits `0x1d02941e`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,361,303,728,536` expected hashes |
| **supply** | `20997.96752697 ROFL` in `2817` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2816` | `b2543a7d565438cef645…` | [@ywltby](https://github.com/ywltby) | `以前说拿了世界冠军就不骂我了，` | `1` | `0.00610351` | 2026-09-17 18:06 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1083` | `38.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.87840667 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2816. Verify it yourself: <code>python3 verify.py</code></sub>

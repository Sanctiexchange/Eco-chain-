...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2675"><img src="assets/ledger-light.svg?v=2675" width="100%" alt="ROFL ledger, height 2675"></picture>

| | |
|---|---|
| **height** | `2675` |
| **tip** | `b8fbd89adec5d7a342bd5c693e422a0259b22020996487bbbe442ce2f547f27e` |
| **difficulty** | `2,919.5`  (bits `0x1d016729`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,027,017,931,752` expected hashes |
| **supply** | `20996.77734198 ROFL` in `2676` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `999` | `37.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `733.12767455 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2675. Verify it yourself: <code>python3 verify.py</code></sub>

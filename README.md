...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2951"><img src="assets/ledger-light.svg?v=2951" width="100%" alt="ROFL ledger, height 2951"></picture>

| | |
|---|---|
| **height** | `2951` |
| **tip** | `9a8cf4b8e8767297f7883babc1136f7afda44399bcc13f49898ebaceb29e6570` |
| **difficulty** | `331.5`  (bits `0x1d0c5b71`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,491,837,878,316` expected hashes |
| **supply** | `20998.75487970 ROFL` in `2952` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `2951` | `9a8cf4b8e8767297f788…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.00305175` | 2026-09-18 21:36 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1152` | `39.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.26903126 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2951. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2242"><img src="assets/ledger-light.svg?v=2242" width="100%" alt="ROFL ledger, height 2242"></picture>

| | |
|---|---|
| **height** | `2242` |
| **tip** | `036f158902d02701a3d731d55d1057d7eb8ec4a9270e1b44fb9d5517431e50cc` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,680,362,738,294` expected hashes |
| **supply** | `20986.47460866 ROFL` in `2243` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `738` | `32.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `726.47484320 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2242. Verify it yourself: <code>python3 verify.py</code></sub>

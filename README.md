...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2394"><img src="assets/ledger-light.svg?v=2394" width="100%" alt="ROFL ledger, height 2394"></picture>

| | |
|---|---|
| **height** | `2394` |
| **tip** | `ef4dca86c5dd40034325029f6f5a5f0e4dbe151fa33c58969edb60bb72116aa4` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,158,515,987,718` expected hashes |
| **supply** | `20991.82128780 ROFL` in `2395` unspent outputs |
...
| `2385` | `b19336176d4f7e757843…` | [@ywltby](https://github.com/ywltby) | `VCTCN，你们的王回来了！` | `1` | `0.02441406` | 2026-09-14 19:39 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `851` | `35.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `730.60081934 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2394. Verify it yourself: <code>python3 verify.py</code></sub>

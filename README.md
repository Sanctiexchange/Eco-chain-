...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2154"><img src="assets/ledger-light.svg?v=2154" width="100%" alt="ROFL ledger, height 2154"></picture>

| | |
|---|---|
| **height** | `2154` |
| **tip** | `646cc7139b3b6cf909b11b51d3eb3f30ce4e0a8e8e676c13346895c6a95dd2d9` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,403,537,172,838` expected hashes |
| **supply** | `20982.17773410 ROFL` in `2155` unspent outputs |
...
| `2150` | `e2472632ec7a1c4cc199…` | [@ywltby](https://github.com/ywltby) | `T1我们明天就把你送回家。` | `1` | `0.04882812` | 2026-09-13 11:16 UTC |
| `2149` | `0676bc5f5b30284b1e7e…` | [@ywltby](https://github.com/ywltby) | `以前说拿了世界冠军就不骂我了，` | `1` | `0.04882812` | 2026-09-13 11:09 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `672` | `31.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `723.25218728 ROFL` |
...
| [@k11agent](https://github.com/k11agent) | `rofl1qewcjd6x7catlvufhqr9ml6ul3j2d3up367fzmx` | `2.68554682 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2154. Verify it yourself: <code>python3 verify.py</code></sub>

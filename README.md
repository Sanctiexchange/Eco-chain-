...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2885"><img src="assets/ledger-light.svg?v=2885" width="100%" alt="ROFL ledger, height 2885"></picture>

| | |
|---|---|
| **height** | `2885` |
| **tip** | `1c726462b445f642ba8e710de457cdf4fee1949f999984768ca06feff7379583` |
| **difficulty** | `876.6`  (bits `0x1d04ac31`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,453,297,768,334` expected hashes |
| **supply** | `20998.38866916 ROFL` in `2886` unspent outputs |
...
| `2876` | `34c7c9f6d2670dae8849…` | [@b81913221-ai](https://github.com/b81913221-ai) | `gm` | `1` | `0.00610351` | 2026-09-18 05:41 UTC |
...
| [@hbzhong](https://github.com/hbzhong) | `156` | `5.4%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.20336867 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2885. Verify it yourself: <code>python3 verify.py</code></sub>

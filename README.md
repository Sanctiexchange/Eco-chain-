...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2296"><img src="assets/ledger-light.svg?v=2296" width="100%" alt="ROFL ledger, height 2296"></picture>

| | |
|---|---|
| **height** | `2296` |
| **tip** | `eee1b9affcd9d3d54cab01fc3f7d4d194f434a190cb626e7b53bbe90189ff87a` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,366,850,232,971,642` expected hashes |
| **supply** | `20989.11132714 ROFL` in `2297` unspent outputs |
...
| `2287` | `774b3ca9b790df1bddde…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.04882812` | 2026-09-14 05:14 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `783` | `34.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `728.67210860 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2296. Verify it yourself: <code>python3 verify.py</code></sub>

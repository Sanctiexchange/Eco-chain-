...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2938"><img src="assets/ledger-light.svg?v=2938" width="100%" alt="ROFL ledger, height 2938"></picture>

| | |
|---|---|
| **height** | `2938` |
| **tip** | `a52750d8878b3cff7f8b4a4e6fd1119227b782eb7750afd238c976e1670995dd` |
| **difficulty** | `384.7`  (bits `0x1d0aa5a3`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,487,040,351,500` expected hashes |
| **supply** | `20998.71215519 ROFL` in `2939` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1141` | `38.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.23241025 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2938. Verify it yourself: <code>python3 verify.py</code></sub>

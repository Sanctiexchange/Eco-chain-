...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2631"><img src="assets/ledger-light.svg?v=2631" width="100%" alt="ROFL ledger, height 2631"></picture>

| | |
|---|---|
| **height** | `2631` |
| **tip** | `2909602c0f396587ae6e86666e0c2dbe42f31edd0bf9600dda17fa17c413aa37` |
| **difficulty** | `2,741.1`  (bits `0x1d017e8b`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,899,960,011,436` expected hashes |
| **supply** | `20996.24023266 ROFL` in `2632` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2631. Verify it yourself: <code>python3 verify.py</code></sub>

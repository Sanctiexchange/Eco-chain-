...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2958"><img src="assets/ledger-light.svg?v=2958" width="100%" alt="ROFL ledger, height 2958"></picture>

| | |
|---|---|
| **height** | `2958` |
| **tip** | `e2153ffe23e7327c752a90463dad13a51e5c40645fd7bbb88836ccc97d36888e` |
| **difficulty** | `331.5`  (bits `0x1d0c5b71`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,494,270,855,695` expected hashes |
| **supply** | `20998.77624195 ROFL` in `2959` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1159` | `39.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.29039351 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2958. Verify it yourself: <code>python3 verify.py</code></sub>

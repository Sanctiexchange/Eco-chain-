...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2352"><img src="assets/ledger-light.svg?v=2352" width="100%" alt="ROFL ledger, height 2352"></picture>

| | |
|---|---|
| **height** | `2352` |
| **tip** | `5d9f0c1ad1a2c1b6b78aa6980f53523b1a993bb22b51af4de022ea1a56075f8e` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,026,394,695,114` expected hashes |
| **supply** | `20990.79589728 ROFL` in `2353` unspent outputs |
...
| `2343` | `9c7b6f1b26fbaecd93cc…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.02441406` | 2026-09-14 13:31 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `828` | `35.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `730.03929596 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2352. Verify it yourself: <code>python3 verify.py</code></sub>

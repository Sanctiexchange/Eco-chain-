...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2625"><img src="assets/ledger-light.svg?v=2625" width="100%" alt="ROFL ledger, height 2625"></picture>

| | |
|---|---|
| **height** | `2625` |
| **tip** | `cef955815ddd7a722488f74cd015cdedfce9f2f74af3b1df876c2cf025b7eabc` |
| **difficulty** | `2,741.1`  (bits `0x1d017e8b`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,882,714,707,498` expected hashes |
| **supply** | `20996.16699048 ROFL` in `2626` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `967` | `36.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `732.73704959 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2625. Verify it yourself: <code>python3 verify.py</code></sub>

...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2813"><img src="assets/ledger-light.svg?v=2813" width="100%" alt="ROFL ledger, height 2813"></picture>

| | |
|---|---|
| **height** | `2813` |
| **tip** | `7f3956ded53108c35087c7784890e4fc597554b90a2b236dfe5291824c7637e1` |
| **difficulty** | `1,706.4`  (bits `0x1d02667b`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,356,059,426,862` expected hashes |
| **supply** | `20997.94921644 ROFL` in `2814` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2813. Verify it yourself: <code>python3 verify.py</code></sub>

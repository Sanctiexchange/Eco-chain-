...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2417"><img src="assets/ledger-light.svg?v=2417" width="100%" alt="ROFL ledger, height 2417"></picture>

| | |
|---|---|
| **height** | `2417` |
| **tip** | `d4c7747e544df289f53809bfbc8444d044670e0b237d850a4d1b94adfb6cc57d` |
| **difficulty** | `3,000.0`  (bits `0x1d015d86`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,367,230,868,124,144` expected hashes |
| **supply** | `20992.38281118 ROFL` in `2418` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `868` | `35.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `731.01585836 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 2417. Verify it yourself: <code>python3 verify.py</code></sub>
